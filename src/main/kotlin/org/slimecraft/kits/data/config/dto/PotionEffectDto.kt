...
data class PotionEffectDto(val id: String, val amplifier: Byte, val duration: Int, val ambient: Boolean, val showParticles: Boolean = true, val showIcon: Boolean = true) {
